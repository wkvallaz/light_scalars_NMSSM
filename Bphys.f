...
! wolf adding Y21 : without the commented-out parts, same as y31?
      epsY21=0d0
      do i=1,2
      do k=1,2
      epsY21=epsY21
...
! wolf ****************************************************************
! new section to explicitly get the couplings A-b-s, A-b-d, etc.
!  using the same structure as above but inserting the x_u,d^A terms
!  from (3.55) ********************************************************
