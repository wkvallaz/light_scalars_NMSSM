...
plt.legend()
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_tanB_v_lambda_kappa.png".format(
...
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_lambda_v_kappa.png".format(
							out_file_name, out_file_name))
...
plt.legend()
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_tanB_v_mueff_Alambda_Akappa.png".format(
							out_file_name, out_file_name))
...
plt.legend()
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_mueff_v_Alambda_Akappa.png".format(
							out_file_name, out_file_name))
...
plt.ylabel("Akappa")
plt.xlabel("Alambda")
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_Akappa_v_Alambda.png".format(
							out_file_name, out_file_name))
...
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_tanB_v_s1mass.png".format(
							out_file_name, out_file_name))
...
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_tanB_v_p1mass.png".format(
							out_file_name, out_file_name))
...
plt.legend()
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_Akappa_v_Alambda_mueff.png".format(
							out_file_name, out_file_name))
...
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_tanB_v_s3mass.png".format(
							out_file_name, out_file_name))
...
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_Akappa_v_Alambda_1.png".format(
							out_file_name, out_file_name))
...
cbar = plt.colorbar()
cbar.ax.set_ylabel("tanB")
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_Akappa_v_Alambda_2.png".format(
							out_file_name, out_file_name))
...
plt.savefig("/home/wolf/NMSSMTools_6.0.0/calculations/{}/{}_tanB_v_s2mass.png".format(
							out_file_name, out_file_name))
