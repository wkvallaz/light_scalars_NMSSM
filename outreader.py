...
def GeneratePlots():#(out_file_name, file_index, SAVEFIGS):#####NEXT STEP, PUT A LOOP AROUND EACH PLOT SO IT CAN BE DELETED ONCE SAVEFIG'D
	...
	for file_index,out_file_matrix in enumerate(file_matrices):##### LOOPING MEANS PLTCTR WEIRD BUT MIGHT NOT EVEN NEED
		plt.scatter([r[19] for r in out_file_matrix], [r[1] for r in out_file_matrix], 
			alpha=Alpha[file_index], color=Color[file_index], s=Size[file_index], label=Label[file_index]) 
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_lambda.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_kappa.png".format(
							save_dir_name))
	plt.close()
...
#	cbar.ax.set_ylabel("tanB")
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/lambda_v_kappa.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_Alambda.png".format(
							save_dir_name))
	plt.close()
	...
	for fx,out_file_matrix in enumerate(file_matrices):
		plt.scatter([r[22] for r in out_file_matrix], [r[1] for r in out_file_matrix],
			alpha=Alpha[fx], c=Color[fx], s=Size[fx], label=Label[fx])
	plt.title("tanB v Akappa")
	plt.ylabel("tanB")
	plt.xlabel("Akappa")
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_Akappa.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_mueff.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/mueff_v_Alambda.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/mueff_v_Akappa.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_Alambda.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_s1mass.png".format(
							save_dir_name))
	plt.xlim(112.5,132.5)
	plt.savefig("{}{}/tanB_v_s1mass_zoom.png".format(DIR, save_dir_name))
	plt.close()	
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_s1mass.png".format(
							save_dir_name))
	plt.xlim(112.5,132.5)
	plt.savefig("{}{}/Akappa_v_s1mass_zoom.png".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Alambda_v_s1mass.png".format(
							save_dir_name))
	plt.xlim(112.5,132.5)
	plt.savefig("{}{}/Alambda_v_s1mass_zoom.png".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_s2mass.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_s2mass.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Alambda_v_s2mass.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_s3mass.png".format(
							save_dir_name))
	plt.xlim(0,35000)
	plt.savefig("{}{}/tanB_v_s3mass_zoom.png".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_s3mass.png".format(
							save_dir_name))
	plt.xlim(0,35000)
	plt.savefig("{}{}/Akappa_v_s3mass_zoom.png".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Alambda_v_s3mass.png".format(
							save_dir_name))
	plt.xlim(0,35000)
	plt.savefig("{}{}/Alambda_v_s3mass_zoom.png".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_p1mass.png".format(
							save_dir_name))
	plt.xlim(0,10000)
	plt.savefig("{}{}/tanB_v_p1mass_zoom".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Alambda_v_p1mass.png".format(
							save_dir_name))
	plt.xlim(0,10000)
	plt.savefig("{}{}/Alambda_v_p1mass_zoom".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_p1mass.png".format(
							save_dir_name))
	plt.xlim(0,10000)
	plt.savefig("{}{}/Akappa_v_p1mass_zoom".format(DIR, save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Alambda_v_p2mass.png".format(
							save_dir_name))
	plt.xlim(0,31000)
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Alambda_v_p2mass_zoom.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_p2mass.png".format(
							save_dir_name))
	plt.xlim(0,31000)
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/Akappa_v_p2mass_zoom.png".format(
							save_dir_name))
	plt.close()
	...
	plt.legend()
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_p2mass.png".format(
							save_dir_name))
	plt.xlim(0,31000)
	plt.savefig(
	"/home/wolf/NMSSMTools_6.0.0/calculations/{}/tanB_v_p2mass_zoom.png".format(
							save_dir_name))
	plt.close()
...
#		print(out_file_name)
		...
		#		print()
			...
			if (NearSM(shiggs[0]) and NearSM(shiggs[2])): mh_1n2[file_index]+=1
		#		print("Wait, really?{}:event{}:s1@{}:s2@{}".format(
		#			out_file_name,indexrow,shiggs[0],shiggs[2]))
			elif (NearSM(shiggs[0])): mh_is1[file_index]+=1
			elif (NearSM(shiggs[0])): mh_is2[file_index]+=1
			elif (NearSM(shiggs[4])): mh_is3[file_index]+=1
